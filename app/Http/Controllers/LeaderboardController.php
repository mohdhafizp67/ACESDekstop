...
class LeaderboardController extends Controller
{
  public function viewLeaderboard()
  {
    ...
    $student = DB::table('students')->select(DB::raw('leaderboards.scores, (IFNULL(leaderboards.scores, 0)) as total_points, students.id as id, users.profile_picture as profile_picture, users.name as name, users.school as school, users.state as state'))
    ...
    //     ->get();
      ...
      //  ->get();
       ...
       $all_students =  DB::table('students')->select(DB::raw('leaderboards.scores, (IFNULL(leaderboards.scores, 0)) as total_points, users.id as user_id'))
        // ->leftJoin("students_games", "students_games.student_id", "=", "students.id")
        // ->leftJoin("students_quizes", "students_quizes.student_id", "=", "students.id")
        ->leftJoin("leaderboards", "leaderboards.student_id", "=", "students.id")
        ->join("users", "users.id", "=", "students.user_id")
    ...
    $current_user = DB::table('students')->select(DB::raw('leaderboards.scores, (IFNULL(leaderboards.scores, 0)) as total_points, students.id as id, users.profile_picture as profile_picture, users.name as name, users.school as school, users.state as state'))
      // ->leftJoin("students_games", "students_games.student_id", "=", "students.id")
      // ->leftJoin("students_quizes", "students_quizes.student_id", "=", "students.id")
      ->leftJoin("leaderboards", "leaderboards.student_id", "=", "students.id")
      ->join("users", "users.id", "=", "students.user_id")
