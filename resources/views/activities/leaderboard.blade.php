             ...
             <div class="modal-dialog">
               ...
               <div class="modal-content">
                 ...
                 <div class="modal-body">
                   ...
                   <span id="my_image" class="social__link" onclick="fbs_click(this)" alt="{{ asset('concept/images/loading.gif') }}"><i class="fa fa-facebook-square" style="font-size: 30px;"></i></span>&nbsp
