                      ...
                      <div class="card-body p-0">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <div class="form-group">
                                 <label for="message" style="color:black;font-size:15px;">Message:</label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            ...
                            <a href="#" class="btn btn-block btn-primary" data-toggle="modal" data-target="#exampleModal" >Post announcement</a>
                          </div>
                          <div class="col-md-2">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="button" class="btn btn-primary">Announcement Post</button>
                                    </div>
                                </div>
                            </div>
                        </div>
