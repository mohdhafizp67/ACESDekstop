                ...
                <div class="card-body p-0">
                    ...
                    <form class="" action="{{ route('admin.others.audit-trail.audit-trail-log.filter') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label>From :</label>
                                <input id="tarikh_mula" class="form-control bg-light" type="date" name="tarikh_mula"
                                    required>
                            </div>
                            <div class="col-md-4">
                                <label>To :</label>
                                <input id="tarikh_akhir" class="form-control bg-light" type="date" name="tarikh_akhir"
                                    required>
                            </div>
                            <div class="col-md-3">
                                <div style="padding:15px;"></div>
                                <button type="submit" class="btn btn-primary m-auto" name="button"><i class="fa fa-search"
                                        aria-hidden="true"></i> Filter</button>
                                <a href="{{ route('admin.others.audit-trail.audit-trail-log') }}"
                                    class="btn btn-primary m-auto"><i class="fa fa-refresh" aria-hidden="true"></i>
                                    Reset</a>
                            </div>
                        </div>
                    </form>
