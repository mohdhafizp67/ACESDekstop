                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                             <div class="card border-3 border-top" style="border-radius: 25px";>
                                 <div class="card-body border-radius" style="background-color: #fff";>
                                     ...
                                     <!-- <div class="float-right metric-label d-inline-block text-success font-weight-bold">
                         ...
                         <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                              ...
                              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                      <div class="card border-3 border-top" style="border-radius: 25px";>
                                          <div class="card-body border-radius" style="background-color: #fff";>
                                              <h5 class="text-muted">ECERDC Staff</h5>
                                              <div class="metric-value d-inline-block">
                                  ...
                                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="card border-3 border-top" style="border-radius: 25px";>
                                                <div class="card-body border-radius" style="background-color: #fff";>
                                                    <h5 class="text-muted">Total Administrator</h5>
                                                    <div class="metric-value d-inline-block">
                                                        <h1 class="mb-1">{{$totalAdmin}}</h1>
                                                    </div>
                                                    <!-- <div class="float-right metric-label d-inline-block text-danger font-weight-bold">
                                                        <span class="icon-circle-small icon-box-xs text-danger bg-danger-light "><i class="fa fa-fw fa-arrow-down"></i></span><span class="ml-1">4%</span>
                                                    </div> -->
                                                </div>
                                            </div>
                                        </div>
