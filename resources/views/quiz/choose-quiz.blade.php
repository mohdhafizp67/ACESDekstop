...
<div class="container-fluid" style="background-image: url({{asset('concept/images/galaxy/background_blue.png')}}); background-position: 40% 40%;background-repeat: no-repeat;background-size: cover;padding: 0%;">
    ...
    <div class="row" style="padding: 1%;">
      <div class="col-md-4">
        <img src="{{asset('concept/images/galaxy/mascot.gif')}}" width="90%" style="margin-top: 38.5%;background-position: 100% 100%;background-repeat: no-repeat;background-size: cover;margin-left: -3%;">
