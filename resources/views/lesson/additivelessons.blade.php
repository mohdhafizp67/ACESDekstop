...
<div id="wrapper">
	...
	<div class="row">
		...
		<div class="col-md-12">
      <h1 style="padding-top: 1%; padding-bottom: 4%;text-align: center;color: #fff; font-weight: bold;font-size: 250%;">ADDITIVE MANUFACTURING</h1>
		</div>
    ...
    <div class="col-md-10" style="background-image: url({{asset('concept/images/galaxy/panel.png')}}); background-position: 40% 40%;background-repeat: no-repeat;background-size: cover;">
                    ...
                    <div class="tab-regular" style="margin-left: 5%;">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="home2-tab" data-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="false" style="font-size: 100%;">3D Printing</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/YEg7ikK19Lw?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>

                            <div class="tab-pane fade" id="home2" role="tabpanel" aria-labelledby="home2-tab">
                              <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/OUHW8iKiN2o?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                              ...
                              <div id="id01" class="w3-modal">
                                <div class="w3-modal-content w3-card-4">
                                  ...
                                  <div class="w3-container">
                                    <iframe width="100%" height="300px" src="https://www.youtube.com/embed/YxeNE6XFcP0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                  </div>
                              ...
                              <script>
                                ...
                                <div id="id02" class="w3-modal">
                                  <div class="w3-modal-content w3-card-4">
                                    ...
                                    <div class="w3-container">
                                      <iframe width="100%" height="300px" src="https://www.youtube.com/embed/t4S0mKjXtT4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                ...
                                <script>
                                  ...
                                  <div id="id03" class="w3-modal">
                                    <div class="w3-modal-content w3-card-4">
                                      ...
                                      <div class="w3-container">
                                        <iframe width="100%" height="300px" src="https://www.youtube.com/embed/NYDzsPvywPc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                      </div>
