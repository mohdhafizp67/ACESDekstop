...
@section('content')
<head>
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" charset="utf-8"></script>
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js" charset="utf-8"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/font-awesome.css" charset="utf-8"></script>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <h2 id="heading">ACES IR 4.0 Lessons</h2>
                <form id="msform">
                    <!-- progressbar -->
                    <ul id="progressbar">
                        <li class="active" id="account"><strong>Introduction to Industrial Revolution</strong></li>
                        <li id="personal"><strong>Pillar of Industrial Revolution 4.0</strong></li>
                        <li id="payment"><strong>1) Big Data and Data analytics</strong></li>
                        <li id="confirm"><strong>2) Cyber Security in Industry 4.0</strong></li>
                        <li id="account"><strong>3) Horizontal and Vertical Integration</strong></li>
                        <li id="personal"><strong>4) Industrial Internet of Things</strong></li>
                        <li id="payment"><strong>5) Autonomous Robots</strong></li>
                        <li id="confirm"><strong>6) Augmented Reality</strong></li>
                        <li id="account"><strong>7) Simulation</strong></li>
                        <li id="personal"><strong>8) The Cloud</strong></li>
                        <li id="payment"><strong>9) 3D Printing</strong></li>
                    </ul>
                    <div class="progress">
