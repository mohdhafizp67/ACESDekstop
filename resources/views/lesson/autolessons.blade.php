...
<html lang="en" style="background-color: #000a11 !important;">
  ...
  <body>
	...
	<div class="row">
		...
		<div class="col-md-12">
      <h1 style="padding-top: 1%; padding-bottom: 4%;text-align: center;color: #fff; font-weight: bold;font-size: 250%;">AUTONOMOUS ROBOT</h1>
		</div>
    ...
    <div class="col-md-10" style="background-image: url({{asset('concept/images/galaxy/panel.png')}}); background-position: 40% 40%;background-repeat: no-repeat;background-size: cover;">
                    ...
                    <div class="tab-regular" style="margin-left: 5%;">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="home2-tab" data-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="false" style="font-size: 100%;">Autonomous Robots vs Teleoperated Robots</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/8w04SvAH0pE?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>

                            <div class="tab-pane fade" id="home2" role="tabpanel" aria-labelledby="home2-tab">
                              <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/xbNVLFibjmQ?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            ...
                            <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="profile-tab" style="width:95%; height:350px;">
                              ...
                              <p onclick="document.getElementById('id01').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">How Autonomous Robots Are Changing Construction<span></p>
                              ...
                              <div id="id01" class="w3-modal">
                                <div class="w3-modal-content w3-card-4">
                                  ...
                                  <div class="w3-container">
                                    <iframe width="100%" height="300px" src="https://www.youtube.com/embed/zBvvbOLq3t0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                  </div>
                              ...
                              <script>
                                ...
                                <p onclick="document.getElementById('id02').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">Autonomous Mobile Robots (AMRs) in Action<span></p>
                                ...
                                <div id="id02" class="w3-modal">
                                  <div class="w3-modal-content w3-card-4">
                                    ...
                                    <div class="w3-container">
                                      <iframe width="100%" height="300px" src="https://www.youtube.com/embed/M0fL5Q6rGws" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                ...
                                <script>
                                  ...
                                  <p onclick="document.getElementById('id03').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">Autonomous Electric Tractor - Future of Farming<span></p>
                                  ...
                                  <div id="id03" class="w3-modal">
                                    <div class="w3-modal-content w3-card-4">
                                      ...
                                      <div class="w3-container">
                                        <iframe width="100%" height="300px" src="https://www.youtube.com/embed/gMaQq_vRaa8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                      </div>
      ...
      <div class="items">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="display-container" style="text-align: center">
                      <img class="mySlides2" src="{{asset('concept/images/pelajaran/auto/autoskills.jpeg')}}" style="width:100%">
                      <span>This slides will be play automatically</span>
                  </div>
        ...
        <div class="modal fade" id="prospek" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="display-container" style="text-align: center">
                    <img class="mySlides1" src="{{asset('concept/images/pelajaran/auto/autocareer.jpeg')}}" style="width:100%">
                    <span>This slides will be play automatically</span>
                  </div>
                  <!-- <div class="w3-content w3-display-container">
    ...
    <!-- <script>
      ...
      <!-- <script>
        ...
        window.onload = function () {
          //display timer
          var fiveMinutes = 142 * 1,
              display = document.querySelector('#time');
          startTimer(fiveMinutes, display);

          //timer for auto submit form/quiz
          var setTimer = (1 * 142) * 1000;
          // var setTimer = 5000;
          window.setTimeout(function() {
            $.ajax({
              type:"get",
               url:"/lesson/ajax/update-lesson/10",
