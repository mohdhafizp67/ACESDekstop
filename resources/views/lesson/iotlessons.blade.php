...
<div id="wrapper">
	...
	<div class="row">
		...
		<div class="col-md-12">
      <h1 style="padding-top: 1%; padding-bottom: 4%;text-align: center;color: #fff; font-weight: bold;font-size: 250%;">IOT LESSONS</h1>
		</div>
                    ...
                    <div class="tab-regular" style="margin-left: 5%;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="profile-tab" style="width:95%; height:350px;">
                              ...
                              <p onclick="document.getElementById('id01').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">What is IoT?<span></p>
                              ...
                              <script>
                                ...
                                <p onclick="document.getElementById('id02').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">Top 10 IoT(Internet Of Things) Projects Of All Time<span></p>
                                ...
                                <script>
                                  ...
                                  <p onclick="document.getElementById('id03').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">Useful IoT Devices | Smart IoT Projects | IoT Applications<span></p>
      ...
      <div class="items">
        ...
        <div class="modal fade" id="lokasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <div class="w3-content w3-display-container" style="text-align: center">
                <img class="career" src="{{asset('concept/images/pelajaran/courses/iotcourseshd.jpg')}}" style="width:100%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="display-container" style="text-align: center">
                    <img class="mySlides1" src="{{asset('concept/images/pelajaran/iot/iotskills.jpeg')}}" style="width:100%">
                    <img class="mySlides1" src="{{asset('concept/images/pelajaran/iot/iotskills2.jpeg')}}" style="width:100%">
        ...
        <div class="modal fade" id="prospek" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="w3-content w3-display-container" style="text-align: center">
                    <img class="mySlides2" src="{{asset('concept/images/pelajaran/iot/iotcareer.jpeg')}}" style="width:100%">
