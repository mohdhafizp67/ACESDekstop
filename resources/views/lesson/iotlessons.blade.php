...
<html lang="en" style="background-color: #000a11 !important;">
  ...
  <body>
	...
	<div class="row">
		...
		<div class="col-md-12">
      <h1 style="padding-top: 0%; padding-bottom: 0%; text-align: center;color: #fff; font-weight: bold;margin-top: -3%;font-size: 450%;">IOT LESSONS</h1>
		</div>
    ...
    <div class="col-md-10" style="background-image: url({{asset('concept/images/galaxy/panel.png')}}); background-position: 40% 40%;background-repeat: no-repeat;background-size: cover;">
                    ...
                    <div class="tab-regular" style="margin-left: 5%;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              <iframe class="embed-responsive-item" width="95%" height="450px" src="https://www.youtube.com/embed/UVoMRMTj69s?autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
