...
<div id="wrapper">
	...
	<div class="row">
		...
		<div class="col-md-12">
      <h1 style="padding-top: 1%; padding-bottom: 4%;text-align: center;color: #fff; font-weight: bold;font-size: 250%;">BIG DATA LESSONS</h1>
		</div>
    ...
    <div class="col-md-10" style="background-image: url({{asset('concept/images/galaxy/panel.png')}}); background-position: 40% 40%;background-repeat: no-repeat;background-size: cover;">
                    ...
                    <div class="tab-regular" style="margin-left: 5%;">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="home2-tab" data-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="false" style="font-size: 100%;">Structured Data vs Unstructured Data</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/iojvn1TB2JY?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>

                            <div class="tab-pane fade" id="home2" role="tabpanel" aria-labelledby="home2-tab">
                              <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/Yj6fuyBVIfc?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            ...
                            <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="profile-tab" style="width:95%; height:350px;">
                              ...
                              <p onclick="document.getElementById('id01').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">What Is Big Data?| Introduction To Big Data<span></p>
                              ...
                              <div id="id01" class="w3-modal">
                                <div class="w3-modal-content w3-card-4">
                                  ...
                                  <div class="w3-container">
                                    <iframe width="100%" height="300px" src="https://www.youtube.com/embed/bAyrObl7TYE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                  </div>
                              ...
                              <script>
                                ...
                                <p onclick="document.getElementById('id02').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">How Big Data Could Transform The Health Care Industry<span></p>
                                ...
                                <div id="id02" class="w3-modal">
                                  <div class="w3-modal-content w3-card-4">
                                    ...
                                    <div class="w3-container">
                                      <iframe width="100%" height="300px" src="https://www.youtube.com/embed/_mXrZEIpNMw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
        ...
        <div class="modal fade" id="lokasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <div class="w3-content w3-display-container" style="text-align: center">
                <img class="career" src="{{asset('concept/images/pelajaran/courses/bigdatacourseshd.jpg')}}" style="width:100%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="display-container" style="text-align: center">
                    <img class="mySlides1" src="{{asset('concept/images/pelajaran/bigdata/bigdataskills1.png')}}" style="width:100%">
                    <img class="mySlides1" src="{{asset('concept/images/pelajaran/bigdata/bigdataskills2.png')}}" style="width:100%">
