                    ...
                    <div class="tab-regular" style="margin-left: 5%;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="profile-tab" style="width:95%; height:350px;">
                              ...
                              <p onclick="document.getElementById('id01').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;">INDUSTRY 4.0: SIMULATION<span></p>
    ...
    <!-- <script>
      ...
      <!-- <script>
        ...
        window.onload = function () {
          //display timer
          var fiveMinutes = 130 * 1,
              display = document.querySelector('#time');
          startTimer(fiveMinutes, display);

          //timer for auto submit form/quiz
          var setTimer = (1 * 130) * 1000;
          // var setTimer = 5000;
          window.setTimeout(function() {
            $.ajax({
              type:"get",
               url:"/ACES-Desktop/lesson/ajax/update-lesson/9",
