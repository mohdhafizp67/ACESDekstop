...
<div id="wrapper">
	...
	<div class="row">
		...
		<div class="col-md-12">
      <h1 style="padding-top: 1%; padding-bottom: 4%;text-align: center;color: #fff; font-weight: bold;font-size: 250%;">ADVANCED SIMULATION</h1>
		</div>
    ...
    <div class="col-md-10" style="background-image: url({{asset('concept/images/galaxy/panel.png')}}); background-position: 40% 40%;background-repeat: no-repeat;background-size: cover;">
                    ...
                    <div class="tab-regular" style="margin-left: 5%;">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="home2-tab" data-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="false" style="font-size: 100%;">Advanced Simulation</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/vG1-2jIVyuA?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>

                            <div class="tab-pane fade" id="home2" role="tabpanel" aria-labelledby="home2-tab">
                                <iframe class="embed-responsive-item" width="95%" height="350px" src="https://www.youtube.com/embed/mwUK6QKNYAE?cc_load_policy=1&autoplay=0&controls=0&disablekb=1&rel=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            ...
                            <div class="tab-pane fade" id="link" role="tabpanel" aria-labelledby="profile-tab" style="width:95%; height:350px;">
                              ...
                              <p onclick="document.getElementById('id01').style.display='block'" style="color: #fff;"><i class="fas fa-arrow-circle-right" style="font-size: 150%; color: #00f0ff; margin-top: 2%;"></i><span style="margin-left: 2%;font-size: 150%;pointer-events: none;">Industry 4.0: Simulation<span></p>
                              ...
                              <div id="id01" class="w3-modal">
                                <div class="w3-modal-content w3-card-4">
                                  ...
                                  <div class="w3-container">
                                    <iframe width="100%" height="300px" src="https://www.youtube.com/embed/dR7mktLdCYg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                  </div>
      ...
      <div class="items">
        ...
        <div class="modal fade" id="lokasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <div class="w3-content w3-display-container" style="text-align: center">
                <img class="career" src="{{asset('concept/images/pelajaran/courses/advancedcourseshd.jpg')}}" style="width:100%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="display-container" style="text-align: center">
                    <img class="mySlides2" src="{{asset('concept/images/pelajaran/advanced/advancedskills.jpeg')}}" style="width:100%">
                    <span>This slides will be play automatically</span>
                  </div>
        ...
        <div class="modal fade" id="prospek" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="display-container" style="text-align: center">
                    <img class="mySlides1" src="{{asset('concept/images/pelajaran/advanced/advancedcareer.jpeg')}}" style="width:100%">
      ...
      <!-- <script>
        ...
        window.onload = function () {
          ...
          window.setTimeout(function() {
            $.ajax({
              type:"get",
               url:"/lesson/ajax/update-lesson/9",
