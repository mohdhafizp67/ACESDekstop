...
<div id="wrapper">
	...
	<div class="row">
		...
		<div class="col-md-12">
      <h1 style="padding-top: 1%;padding-bottom: 4%;text-align: center;color: #fff; font-weight: bold;font-size: 250%;">AR/VR LESSONS</h1>
		</div>
      ...
      <!-- <script>
        ...
        window.onload = function () {
          ...
          window.setTimeout(function() {
            $.ajax({
              type:"get",
               url:"/ACES/lesson/ajax/update-lesson/2",
