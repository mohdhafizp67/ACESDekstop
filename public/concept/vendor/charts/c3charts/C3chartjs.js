    ...
    $(function() {
        ...
        if ($('#c3chart_spline').length) {
            var chart = c3.generate({
                ...
                data: {
                    columns: [
                        ['Pelajar Baru', 30, 200, 100, 400, 150, 250],
                        ['Pelajar Lama', 130, 100, 140, 200, 150, 50]
                    ],
                    type: 'spline',
                    colors: {
                         data1: '#5969ff',
        ...
        if ($('#c3chart_zoom').length) {
            var chart = c3.generate({
                ...
                data: {
                    columns: [
                        ['Bulan', 30, 200, 100, 400, 150, 250, 150, 200, 170, 240, 350, 150, 100, 400, 150, 250, 150, 200, 170, 240, 100, 150, 250, 150, 200, 170, 240, 30, 200, 100, 400, 150, 250, 150, 200, 170, 240, 350, 150, 100, 400, 350, 220, 250, 300, 270, 140, 150, 90, 150, 50, 120, 70, 40]
                    ],
                    colors: {
                        sample: '#000'
